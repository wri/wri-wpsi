...
ActiveRecord::Schema.define(version: 2024_12_20_120000) do
  ...
  create_table "info_modals", force: :cascade do |t|
    t.string "title", null: false
    t.text "content", null: false
    t.string "info_modal_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["info_modal_id"], name: "index_info_modals_on_info_modal_id", unique: true
  end
